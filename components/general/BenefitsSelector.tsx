    ...
    return (
        ...
        <div className="flex flex-wrap gap-3">
            {benefits.map((benefit) => {
                ...
                return (
                    <Badge className="cursor-pointer transition-all hover:scale-105 active:scale-95 px-4 py-1.5 rounded-full" key={benefit.id} variant={isSelected ? "default" : "outline"} onClick={() => toggleBenefit(benefit.id)}>
