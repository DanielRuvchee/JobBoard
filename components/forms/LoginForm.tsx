            ...
            <Card>
                ...
                <CardContent className="flex flex-col gap-4">
                    <form action={signInWithGithub}>
                        <GeneralSubmitButtons text="Login with GitHub" variant="outline" width="w-full" icon={<Github className="size-4" />}/>
                    </form>

                    <form>
                    <GeneralSubmitButtons text="Login with Google" variant="outline" width="w-full" icon={<Google className="size-4" />}/>
                    </form>
                </CardContent>
            </Card>
